...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		...
		_, err = codebuild.NewProject(ctx, "serverlesscodebuildProject", &codebuild.ProjectArgs{
		...
		_, err = codepipeline.NewPipeline(ctx, "serverlesscodepipeline", &codepipeline.PipelineArgs{
